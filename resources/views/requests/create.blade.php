    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('requests.store') }}" method="POST">
                @csrf
                <div class="row mb-2"> {{-- IDENTIFICADOR --}}
                ...
                <div class="row"> {{-- Titulo : Campos Obligatorios --}}
                ...
                <div class="row"> {{-- Titulo: Solicitud de Reproceso --}}
                    <div class="col">
                        <h4>Solicitud de Reproceso</h4>
                        <hr>
                    </div>
                </div>
                <div class="row mb-2 ">{{-- FILA 6 ACTIVIDADA PADRE --}}
                ...
                <div class="row mb-2 justify-content-center"> {{-- FILA 7 --}}
